export const menuList = [
  ...
  { name: '删除', value: 'delete', comment: '勾选生成删除按钮菜单及接口' },
  { name: '回收站列表', value: 'recycle', comment: '勾选生成移到回收站列表按钮及接口，确定该表有delete_time字段，且模型引入了软删除。' },
  { name: '回收站恢复', value: 'recovery', comment: '勾选生成回收站恢复按钮菜单及接口。.' },
  { name: '修改状态', value: 'changeStatus', comment: '勾选生成修改状态按钮菜单及接口，该接口用于单个字段状态修改' },
  { name: '导入', value: 'import', comment: '勾选生成导入按钮菜单、接口文件' },
  { name: '导出', value: 'export', comment: '勾选生成导出按钮菜单、接口文件' },
]
