...
<script setup>
  ...
  const selectOperation = (value, record) => {
    ...
    if (value === 'setHomePage') {
      ...
      homePage.value = record.dashboard
  ...
  const columns = reactive([
    ...
    {
      title: '头像', dataIndex: 'avatar', width: 75, formType: 'upload', returnType: 'url', multiple: false,
    ...
    { 
      title: '岗位', dataIndex: 'post_ids', width: 120, formType: 'select', multiple: false,
