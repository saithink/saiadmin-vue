...
const download = async (record) => {
	...
	if (storeMode !== 'LOCAL') {
		...
		url = '/core/system/downloadById/' + record.id
	}
...
const columns = reactive([
	{ title: 'ID', dataIndex: 'id', addDisplay: false, editDisplay: false, hide: true, width: 50 },
	{
		title: '预览',
		dataIndex: 'url',
		width: 80,
	...
	},
	{
		...
		search: true,
		formType: 'select',
		dict: { name: 'upload_mode', props: { label: 'label', value: 'value' }, translation: true },
	},
	{
		title: '资源类型',
		dataIndex: 'mime_type',
